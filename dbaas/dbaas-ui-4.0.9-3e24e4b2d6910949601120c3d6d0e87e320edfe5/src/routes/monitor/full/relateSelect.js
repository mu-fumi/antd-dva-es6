  ...
  render(){
    ...
    return (
      <InputGroup style={{width:'100%'}}>
        <Select onChange={this.typeChange} value={this.state.type.toString()} style={{width:'40%'}}>
          <Option value="0">集群</Option>
          <Option value="1">实例组</Option>
          <Option value="2">实例</Option>
        </Select>
        <Select onChange={this.idChange} value={this.state.id.toString()} style={{width:'60%'}}>
          {
            relateList.map(v => {
